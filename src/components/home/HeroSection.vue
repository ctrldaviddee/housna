...
<template>
    <div class="mx-auto max-w-[95%] px-4 lg:px-8 mt-24 sm:mt-32 md:mt-56">
      <div class="mx-auto max-w-full lg:max-w-none lg:flex">
        ...
        <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
          <div class="hero-image -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
            <img
