    ...
    <svg
                        ...
                        <defs>
                            <pattern id=":Rp7qlba:" width="96" height="480" x="50%" patternUnits="userSpaceOnUse"
                                patternTransform="translate(0 -256)" fill="none">
                                <path
          ...
          <figure class="mx-auto max-w-4xl">
            <blockquote class="relative font-display text-3xl font-medium tracking-tight text-neutral-950 sm:text-4xl">
              <p class="before:content-[\u0022] after:content-[\u0022] sm:before:absolute sm:before:right-full">
                A very efficient parcel and freight transport service. I really like their package tracking system.
              </p>
            </blockquote>
            <figcaption class="mt-10">
              <img src="@/assets/testimonial-avatar.jpg" alt="" class="h-12 w-12 rounded-full">
              <div class="mt-4">
                <div class="font-display text-base font-medium text-neutral-950">Jenny Wilson</div>
                <!-- <div class="mt-1 text-sm text-neutral-600">CPO of Unseal</div> -->
              </div>
            </figcaption>
          </figure>
        </FadeIn>
