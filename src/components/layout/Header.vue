...
<template>
  <header>
    <div class="absolute top-2 right-0 left-0 z-40 pt-14">
      <div class="mx-auto max-w-[95%] px-4 lg:px-8">
    ...
    >
      <div
        v-if="isMenuOpen"
        class="relative min-h-screen z-50 overflow-hidden bg-neutral-950 pt-24"
      >
        <div class="bg-neutral-950">
          <div class="mx-auto max-w-[90%] px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:max-w-none">
              <div class="flex items-center justify-between">
                <RouterLink to="/" aria-label="Home" @click="closeMenu">
                  <LogoWhite class="h-8" />
                </RouterLink>
                <div class="flex items-center gap-x-8">
                  <RouterLink
          ...
          >
            <div class="mx-auto max-w-[90%] px-6 lg:px-8">
              <div class="mx-auto max-w-2xl lg:max-w-none">
                <div
                  class="grid grid-cols-1 gap-y-10 pt-10 pb-16 sm:grid-cols-2 sm:pt-16"
                >
                  <div>
                    ...
                    >
                      ...
                      <li>
                        <address class="text-sm not-italic text-neutral-300">
                          <strong class="text-white">Billund</strong><br />24
                          Lego Allé<br />7190, Billund, Denmark
                        </address>
                      </li>
                    </ul>
                  </div>
