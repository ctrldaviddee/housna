                ...
                <li v-for="(section, index) in footerSections" :key="index">
                  ...
                  <ul role="list" class="mt-4 text-md  text-neutral-700">
                    <li v-for="(link, linkIndex) in section.links" :key="JSON.stringify(link.href)" class="mt-4">
                      <RouterLink :to="link.href" class="transition hover:text-neutral-950">
                        {{ link.text }}
                      </RouterLink>
                    </li>
                  </ul>
            ...
            <div class="flex lg:justify-end">
              <form class="max-w-sm">
                ...
                <p class="mt-4 text-md tracking-tight text-neutral-700">
                  Souscrivez à notre newsletter pour les dernières ressources .
                </p>
  ...
  const footerSections = [
    {
      title: 'Blekl',
      links: [
        { text: 'FamilyFund', href: '/work/family-fund' },
        { text: 'Unseal', href: '/work/unseal' },
        { text: 'Phobia', href: '/work/phobia' },
        { text: 'Voir tout =>', href: '#' },
        // Add more links
      ]
    },
